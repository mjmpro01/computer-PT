  ...
  if (!control)
    return (
      ...
      >
        ...
        <Select
          className={clsx(
            "w-full font-[500] min-h-[40px] text-[14px] text-black leading-[20px] border-[#000] hover:!border-[#000] focus:border-[#000] focus:shadow-none",
            className
          )}
          {...rest}
        >
    ...
    <div className={clsx("w-auto flex flex-col gap-[6px]", containerClasName)}>
      ...
      <Controller
        ...
        render={({ field: { onChange, onBlur, value, ref } }) => (
          <Select
            className={clsx(
              "w-full font-[500] text-[14px] min-h-[40px] leading-[20px] border-[#000] hover:!border-[#000] focus:border-[#000] focus:shadow-none",
              className
            )}
            onChange={onChange}
            onBlur={onBlur}
