  ...
  return (
    <div className="h-[35rem] flex flex-col p-[1rem] border rounded-[0.4rem] bg-white">
      <div className="relative h-[50%]">
        <img
          src={`http://localhost:1337${product?.attributes?.avatar.data.attributes.url}`}
          alt="image"
      ...
      <Button className="mt-auto w-full h-[4.2rem] text-[#1435C3] border-[#1435C3] rounded-[0.4rem]">
        Thêm vào giỏ hàng
      </Button>
    </div>
  );
