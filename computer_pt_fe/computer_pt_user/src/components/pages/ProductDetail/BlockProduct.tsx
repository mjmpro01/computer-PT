  ...
  return (
    <div className="grid grid-cols-2 gap-[1.2rem] bg-white rounded-[0.4rem] p-[2rem] h-[60rem]">
      ...
      <div className="flex flex-col gap-[2.4rem]">
        <div>
          ...
          <div className="flex items-center gap-[0.8rem]">
            {/* <p className="text-[1.4rem] text-[#82869E]">
              Thương hiệu{" "}
              <span className="text-[#1435C5] cursor-pointer">XIGMATEK</span>
            </p> */}
            {/* <span>|</span> */}
            <p className="text-[1.4rem] text-[#82869E]">
        ...
        <div>
          <p className="text-[2rem] font-bold text-[#1435C5]">
        ...
        <div className="grid grid-cols-2 gap-[0.4rem] py-[2.4rem] border-t border-b">
          <Button
            className="text-white bg-[#1435C5] h-[4rem] rounded-[0.4rem]"
            onClick={() => {
          ...
          <Button
            className="text-[#1435C5] border-[#1435C5] h-[4rem] rounded-[0.4rem]"
        ...
        <div>
          ...
          <ul className="flex flex-col gap-[0.8rem] list-disc mt-[1.2rem]">
            <li className="text-[1.2rem]">
              ...
              Sacombank{" "}
              <span className="text-[#1435C5] cursor-pointer">
                Xem chi tiết
              </span>
            </li>
            <li className="text-[1.2rem]">
